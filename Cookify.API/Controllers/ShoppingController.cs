...
namespace Cookify.API.Controllers
{
    ...
    public class ShoppingController : ControllerBase
    {
        ...
        [HttpPost]
        public IActionResult AddProductToList([FromBody] AddAndRemoveItemInListRequest request)
        {
            HttpContext.Request.Headers.TryGetValue(AppSettings.AuthenticationHeader, out var jwtValues);
            string jwtToken = jwtValues.FirstOrDefault();
        ...
        [HttpDelete]
        public IActionResult RemoveProductFromList([FromBody] AddAndRemoveItemInListRequest request)
        {
            HttpContext.Request.Headers.TryGetValue(AppSettings.AuthenticationHeader, out var jwtValues);
            string jwtToken = jwtValues.FirstOrDefault();
